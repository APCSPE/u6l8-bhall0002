#MY MESSAGE: my name is regina george ---> p|#qdph#lv#uhjlqd#jhrujh, encrptytion key = 3
#THE MESSAGE I DECODED (ming yan mai's message): Why do I have so much work ---> FWhnS^n8nWPeTnb^n\dRWnf^aZ, encryption key = 1018
